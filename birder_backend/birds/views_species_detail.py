...
class SpeciesObservationsView(APIView):
    ...
    def get(self, request, species_id: int):
        user = request.user
        ...
        logs_qs = (
            Log.objects
            .filter(user=user, species_id=species_id)
        ...
        payload = {
            ...
            "photos": SpeciesObservationItemSerializer(photos, many=True).data,
            "logs": SpeciesObservationItemSerializer(logs, many=True).data,
