...
from .views import SignupView, MeView, FindUsernameView, FindPwdView, CheckPwdView, SetPwdView, LogoutView, SettingsView
...
urlpatterns = [
    ...
    path('change-pwd/', FindPwdView.as_view(), name='change_pwd'), # 비밀번호 변경
